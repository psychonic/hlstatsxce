...
('W', 'tf', 'atomizer', 'Atomizer', 'Atomizer kills'),
('W', 'tf', 'bazaar_bargain', 'Bazaar Bargain', 'Bazaar Bargain kills'),
('W', 'tf', 'demokatana', 'Half-Zatoichi', 'Half-Zatoichi kills'),
('W', 'tf', 'detonator', 'Detonator', 'Detonator kills'),
('W', 'tf', 'disciplinary_action', 'Disciplinary Action', 'Disciplinary Action kills'),
('W', 'tf', 'enforcer', 'Enforcer', 'Enforcer kills'),
('W', 'tf', 'eviction_notice', 'Eviction Notice', 'Eviction Notice kills'),
('W', 'tf', 'family_business', 'Family Business', 'Family Business kills'),
('W', 'tf', 'kunai', 'Conniver''s Kunai', 'Conniver''s Kunai kills'),
('W', 'tf', 'lava_axe', 'Sharpened Volcano Fragment', 'Sharpened Volcano Fragment kills'),
('W', 'tf', 'lava_bat', 'Sun-on-a-Stick', 'Sun-on-a-Stick kills'),
('W', 'tf', 'liberty_launcher', 'Liberty Launcher', 'Liberty Launcher kills'),
('W', 'tf', 'mantreads', 'Mantreads', 'Mantreads kills'),
('W', 'tf', 'market_gardener', 'Market Gardener', 'Market Gardener kills'),
('W', 'tf', 'persian_persuader', 'Persian Persuader', 'Persian Persuader kills'),
('W', 'tf', 'proto_syringe', 'Overdose', 'Overdose kills'),
('W', 'tf', 'reserve_shooter', 'Reserve Shooter', 'Reserve Shooter kills'),
('W', 'tf', 'scout_sword', 'Three-Rune Blade', 'Three-Rune Blade kills'),
('W', 'tf', 'shahanshah', 'Shahanshah', 'Shahanshah kills'),
('W', 'tf', 'soda_popper', 'Soda Popper', 'Soda Popper kills'),
('W', 'tf', 'solemn_vow', 'Solemn Vow', 'Solemn Vow kills'),
('W', 'tf', 'the_maul', 'Maul', 'Maul kills'),
('W', 'tf', 'the_winger', 'Winger', 'Winger kills'),
('W', 'tf', 'tomislav', 'Tomislav', 'Tomislav kills'),
('W', 'tf', 'warfan', 'Fan O''War', 'Fan O''War kills'),
('W', 'tf', 'big_earner', 'Big Earner', 'Big Earner kills'),
