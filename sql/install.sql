...
('O', 'tf', 'steak', 'Buffalo Steak Sandvich', 'Buffalo Steak Sandviches eaten'),
('W', 'tf', 'claidheamohmor', 'Claidheamohmor', 'Claidheamohmor kills'),
('W', 'tf', 'back_scratcher', 'Back Scratcher', 'Back Scratcher kills'),
('W', 'tf', 'boston_basher', 'Boston Basher', 'Boston Basher kills'),
('W', 'tf', 'steel_fists', 'Fists of Steel', 'kills with the Fists of Steel'),
('W', 'tf', 'amputator', 'Amputator', 'Amputator kills'),
('W', 'tf', 'tf_projectile_healing_bolt', 'Crusader''s Crossbow', 'Crusader''s Crossbow kills'),
('W', 'tf', 'ullapool_caber', 'Ullapool Caber', 'Ullapool Caber kills'),
('W', 'tf', 'lochnload', 'Loch-n-Load', 'Loch-n-Load kills'),
('W', 'tf', 'brassbeast', 'Brass Beast', 'Brass Beast kills'),
('W', 'tf', 'bear_claws', 'Warrior''s Spirit', 'Warrior''s Spirit kills'),
('W', 'tf', 'candy_cane', 'Candy Cane', 'Candy Cane kills'),
('W', 'tf', 'wrench_jag', 'Jag', 'Jag kills'),
('W', 'tf', 'iron_curtain', 'Iron Curtain', 'Iron Curtain kills'),
('W', 'tf', 'headtaker', 'Horseless Headless Horseman''s Headtaker', 'Horseless Headless Horseman''s Headtaker kills'),
('P', 'tf', 'madmilk', 'Mad Milk', 'Mad Milk hits'),
...
('glovesurgent', 1, 0, 'tf', '1_glovesurgent.png', 'Bronze Gloves of Running Urgently'),
('glovesurgent', 5, 0, 'tf', '2_glovesurgent.png', 'Silver Gloves of Running Urgently'),
('glovesurgent', 10, 0, 'tf', '3_glovesurgent.png', 'Gold Gloves of Running Urgently'),
...
('sydneysleeper', 1, 0, 'tf', '1_sydneysleeper.png', 'Bronze Sydney Sleeper'),
('sydneysleeper', 5, 0, 'tf', '2_sydneysleeper.png', 'Silver Sydney Sleeper'),
('sydneysleeper', 10, 0, 'tf', '3_sydneysleeper.png', 'Gold Sydney Sleeper'),
...
('tf_projectile_healing_bolt', 1, 0, 'tf', '1_tf_projectile_healing_bolt.png', 'Bronze Crusader''s Crossbow'),
('tf_projectile_healing_bolt', 5, 0, 'tf', '2_tf_projectile_healing_bolt.png', 'Silver Crusader''s Crossbow'),
('tf_projectile_healing_bolt', 10, 0, 'tf', '3_tf_projectile_healing_bolt.png', 'Gold Crusader''s Crossbow'),
...
('lochnload', 1, 0, 'tf', '1_lochnload.png', 'Bronze Loch-n-Load'),
('lochnload', 5, 0, 'tf', '2_lochnload.png', 'Silver Loch-n-Load'),
('lochnload', 10, 0, 'tf', '3_lochnload.png', 'Gold Loch-n-Load'),
('brassbeast', 1, 0, 'tf', '1_brassbeast.png', 'Bronze Brass Beast'),
('brassbeast', 5, 0, 'tf', '2_brassbeast.png', 'Silver Brass Beast'),
('brassbeast', 10, 0, 'tf', '3_brassbeast.png', 'Gold Brass Beast'),
('bear_claws', 1, 0, 'tf', '1_bear_claws.png', 'Bronze Warrior''s Spirit'),
('bear_claws', 5, 0, 'tf', '2_bear_claws.png', 'Silver Warrior''s Spirit'),
('bear_claws', 10, 0, 'tf', '3_bear_claws.png', 'Gold Warrior''s Spirit'),
...
('madmilk', 1, 0, 'tf', '1_mad_milk.png', 'Bronze Mad Milk'),
('madmilk', 5, 0, 'tf', '2_mad_milk.png', 'Silver Mad Milk'),
('madmilk', 10, 0, 'tf', '3_mad_milk.png', 'Gold Mad Milk'),
...
('tf', 'tf_projectile_healing_bolt', 'The Crusader''s Crossbow', 1.0),
('tf', 'ullapool_caber', 'The Ullapool Caber', 2.0),
('tf', 'lochnload', 'The Loch-n-Load', 1.0),
('tf', 'brassbeast', 'The Brass Beast', 1.0),
('tf', 'bear_claws', 'The Warrior''s Spirit', 2.0),
('tf', 'candy_cane', 'The Candy Cane', 2.0),
('tf', 'wrench_jag', 'The Jag', 2.0),
('tf', 'iron_curtain', 'The Iron Curtain', 1.0),
('tf', 'headtaker', 'The Horseless Headless Horseman''s Headtaker', 2.0),
