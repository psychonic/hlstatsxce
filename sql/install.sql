...
('W', 'tf', 'tf_projectile_healing_bolt', 'Bolts Blown', 'Crusader''s Crossbow kills'),
('W', 'tf', 'ullapool_caber', 'Caber''s Clubbed', 'Ullapool Caber kills'),
('W', 'tf', 'lochnload', 'Loch-n-Load''d', 'Loch-n-Load kills'),
('W', 'tf', 'brassbeast', 'Brass Beast', 'Brass Beast kills'),
('W', 'tf', 'bear_claws', 'Clawed Candyasses', 'Warrior''s Spirit kills'),
