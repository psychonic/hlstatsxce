...
('W', 'l4d2', 'upgradepack_incendiary', 'Buuuuurn', 'kills with Upgrade Pack Smash'),
('W', 'l4d2', 'grenade_launcher', 'More than one way to kill with a Grenade Launcher', 'Grenade Launcher smash kills'),
...
('l4d2', 'upgradepack_incendiary', 'Upgrade Pack Smash', 1.5),
