...
('W','tf','tribalkurki', 'Tribalman''s Shiv', 'kills with the Tribalman''s Shiv'),
...
('tribalkurki', 1, 0, 'tf', '1_tribalkurki.png', 'Brozen Tribalman''s Shiv'),
('tribalkurki', 5, 0, 'tf', '2_tribalkurki.png', 'Silver Tribalman''s Shiv'),
('tribalkurki', 10, 0, 'tf', '3_tribalkurki.png', 'Gold Tribalman''s Shiv'),
...
('tf', 'tribalkurki', 'Tribalman''s Shiv', 'kills with The Tribalman''s Shiv', '2.00'),
('tf', 'battleaxe', 'Scottsman''s Skullcutter', 'kills with The Scotsman''s Skullcutter', '2.00'),
