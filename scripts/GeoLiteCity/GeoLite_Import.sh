...
# Easy import of geoLiteCity CSV Database
# password must be given at the console :)
DBHOST="localhost"
DBNAME=""
DBUSER=""
DBPASS=""
...
DAT=`date +%Y%m01`
FIL="GeoLiteCity_$DAT"
FILE="$FIL.zip"
rm *.csv
[ -f $FILE ] || wget http://www.maxmind.com/download/geoip/database/GeoLiteCity_CSV/$FILE
unzip -o $FIL

mv $FIL/GeoLiteCity-Blocks.csv geoLiteCity_Blocks.csv
mv $FIL/GeoLiteCity-Location.csv geoLiteCity_Location.csv.temp
rmdir $FIL
